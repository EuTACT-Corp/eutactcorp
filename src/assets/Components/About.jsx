            ...
            <div className="p-12 md:px-8 md:py-8 lg:px-16 lg:py-16 flex flex-col md:flex-row items-center">
                ...
                <div className="flex flex-wrap justify-center items-center w-full md:w-1/2">
                    <div className="text-center p-5 w-1/2 md:w-1/3">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primaryGradient">100+</h1>
                        <h5 className="text-xs md:text-sm lg:text-base">Successful Project</h5>
                    </div>
                    <div className="text-center p-5 w-1/2 md:w-1/3">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primaryGradient">5+</h1>
                        <h5 className="text-xs md:text-sm lg:text-base">Years of Experience</h5>
                    </div>
                    <div className="text-center p-5 w-1/2 md:w-1/3">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primaryGradient">1200+</h1>
