...
const Home = () => {
    // Use window size to control animation behavior
                    ...
                    {isLargeScreen ? (
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row mt-4 sm:mt-6 gap-4">
                                {/* Button container */}
                                <div className="relative inline-flex group w-full sm:w-auto">
                                    <div className="absolute opacity-70 -inset-px rounded-xl blur-lg overflow-hidden"></div>
                                    <a href="#Contact" title="Let's Connect"
                                        className="relative inline-flex items-center justify-center w-full sm:w-auto px-10 py-4 text-lg font-bold text-black bg-white font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                                        role="button">
                                        Let's Connect
                                    </a>
                                </div>
