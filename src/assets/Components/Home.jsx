...
const Home = () => {
    return (
        <section id="Home">
            <div className="flex flex-col sm:flex-row justify-around items-center pt-10 h-[100vh] bg-gradient-to-br from-primaryGradient to-secondaryGradient">
                ...
                <div>
                    <img src={HomeImg} alt="" className="w-56 sm:w-60 lg:w-[32rem] mt-6 sm:mt-0" />
                </div>
            </div>
        </section>
    );
